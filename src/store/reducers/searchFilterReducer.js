...
const searchFilterReducer = (state = initialState, action) => {
  switch (action.type) {
    case FILTER_BY_SEARCH:
      console.log("여기호출됨 >", action.payload);
...
//       console.log("action은2", action);
//       console.log("select action type => ", action.type);
//       console.log("우오", action.payload);
//       let sortByPopularityState = Object.assign({}, state);
//       console.log("셀렉트 뭐 눌렀어? >> ", sortByPopularityState);
...
//       const exporters = sortDesc(action.payload, "stars");
//       let AllExporters = exporters.filter((exporter) => {
//         return exporter.official === "Official" || "Unofficial";
//       });
//       const officialCount = AllExporters.length;
//       return {
//         ...state,
//         exporters,
//         filteredExporters: AllExporters,
//         exposedExporters: AllExporters.slice(0, COUNT_PER_SCROLL),
